                ...
                <Row>
                    ...
                    <Col md={4}>
                        <div className="left-side-room">
                            <Slider {...rooms}>
                                <img src={require('./assets/city-continental-twin-bedroom.jpg')} alt="superior2" id="room-suite" />
                            </Slider>
                        </div>               
                    </Col>
                    <Col md={8}>
                        <div className="middle-side-room">
                            ...
                            <ul className="items">
                                ...
                                <div className="right-text">
                                    <Link to="/viewdetails"><button className="service-button">View Details</button></Link>
